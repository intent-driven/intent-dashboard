  ...
  return <Collapse in={props.open} timeout="auto" unmountOnExit>
    <Box sx={{mt: 1.5, backgroundColor: "#FFF8E1"}}>
      <Table size="small" aria-label="purchases">
        <TableHead>
          <TableRow>
            <TableCell><Typography variant="h6" gutterBottom width="69%">Intent Detail</Typography>
              {props.data.name}
            </TableCell>
            <TableCell>
              <Typography variant="h6" gutterBottom width="29%" align={"left"}>State</Typography>
        ...
        <TableBody>
          ...
          <TableRow key={uuid4()}>
            ...
            <TableCell>
              <Typography variant="h6" gutterBottom align={"left"}>TimeStamp</Typography>
              <TreeCell value={props.data.reportTS}/>
            </TableCell>
          </TableRow>
        </TableBody>
      </Table>
